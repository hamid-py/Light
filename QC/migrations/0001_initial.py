# Generated by Django 3.2.9 on 2022-03-09 08:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voice_date', django_jalali.db.models.jDateField(default=datetime.date(2022, 3, 9))),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('modified_date', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voice', models.OneToOneField(limit_choices_to={'created_date__gte': datetime.datetime(2022, 3, 9, 8, 13, 14, 977511)}, on_delete=django.db.models.deletion.CASCADE, related_name='voice', to='QC.voice')),
            ],
        ),
        migrations.CreateModel(
            name='Agent',
